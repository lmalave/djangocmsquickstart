...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductPageExtension'
        db.create_table(u'djangocmsquickstart_productpageextension', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_extension', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft_extension', unique=True, null=True, to=orm['djangocmsquickstart.ProductPageExtension'])),
            ('extended_object', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.Page'], unique=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='product_page_extensions', null=True, to=orm['djangocmsquickstart.Product'])),
        ))
        db.send_create_signal(u'djangocmsquickstart', ['ProductPageExtension'])

        # Adding field 'ProductFeaturePluginModel.product_page'
        db.add_column(u'djangocmsquickstart_productfeaturepluginmodel', 'product_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cms.Page'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProductPageExtension'
        db.delete_table(u'djangocmsquickstart_productpageextension')

        # Deleting field 'ProductFeaturePluginModel.product_page'
        db.delete_column(u'djangocmsquickstart_productfeaturepluginmodel', 'product_page_id')
    ...
    models = {
        ...
        u'djangocmsquickstart.productfeaturepluginmodel': {
            ...
            'product_page': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['cms.Page']", 'null': 'True'})
        },
        u'djangocmsquickstart.productgridpluginmodel': {
            'Meta': {'object_name': 'ProductGridPluginModel', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'djangocmsquickstart.productpageextension': {
            'Meta': {'object_name': 'ProductPageExtension'},
            'extended_object': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.Page']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'product_page_extensions'", 'null': 'True', 'to': u"orm['djangocmsquickstart.Product']"}),
            'public_extension': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'draft_extension'", 'unique': 'True', 'null': 'True', 'to': u"orm['djangocmsquickstart.ProductPageExtension']"})
        },
