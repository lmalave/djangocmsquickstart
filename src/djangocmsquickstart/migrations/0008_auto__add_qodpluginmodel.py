...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QODPluginModel'
        db.create_table(u'djangocmsquickstart_qodpluginmodel', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('quote', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True)),
            ('author', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True)),
        ))
        db.send_create_signal(u'djangocmsquickstart', ['QODPluginModel'])


    def backwards(self, orm):
        # Deleting model 'QODPluginModel'
        db.delete_table(u'djangocmsquickstart_qodpluginmodel')
    ...
    models = {
        ...
        u'djangocmsquickstart.qodpluginmodel': {
            'Meta': {'object_name': 'QODPluginModel', '_ormbases': ['cms.CMSPlugin']},
            'author': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True'}),
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'quote': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True'})
        },
