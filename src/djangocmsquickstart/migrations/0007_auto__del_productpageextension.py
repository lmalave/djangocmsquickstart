...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'djangocmsquickstart_productpageextension', (
            ...
            ('product', self.gf('django.db.models.fields.related.OneToOneField')(default=None, related_name='product_page_extensions', unique=True, null=True, to=orm['djangocmsquickstart.Product'])),
