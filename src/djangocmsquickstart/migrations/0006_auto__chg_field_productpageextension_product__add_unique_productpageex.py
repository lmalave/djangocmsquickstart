...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductPageExtension.product'
        db.alter_column(u'djangocmsquickstart_productpageextension', 'product_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['djangocmsquickstart.Product']))
        # Adding unique constraint on 'ProductPageExtension', fields ['product']
        db.create_unique(u'djangocmsquickstart_productpageextension', ['product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProductPageExtension', fields ['product']
        db.delete_unique(u'djangocmsquickstart_productpageextension', ['product_id'])


        # Changing field 'ProductPageExtension.product'
        db.alter_column(u'djangocmsquickstart_productpageextension', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['djangocmsquickstart.Product']))
    ...
    models = {
        ...
        u'djangocmsquickstart.productpageextension': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.OneToOneField', [], {'default': 'None', 'related_name': "'product_page_extensions'", 'unique': 'True', 'null': 'True', 'to': u"orm['djangocmsquickstart.Product']"}),
