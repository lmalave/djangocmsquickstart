...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductFeaturePluginModel'
        db.create_table(u'djangocmsquickstart_productfeaturepluginmodel', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'djangocmsquickstart', ['ProductFeaturePluginModel'])


    def backwards(self, orm):
        # Deleting model 'ProductFeaturePluginModel'
        db.delete_table(u'djangocmsquickstart_productfeaturepluginmodel')
