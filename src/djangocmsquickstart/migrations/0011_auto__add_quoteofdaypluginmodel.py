...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuoteOfDayPluginModel'
        db.create_table(u'djangocmsquickstart_quoteofdaypluginmodel', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('quote', self.gf('django.db.models.fields.TextField')(default=None, max_length=1000, null=True)),
            ('author', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True)),
        ))
        db.send_create_signal(u'djangocmsquickstart', ['QuoteOfDayPluginModel'])


    def backwards(self, orm):
        # Deleting model 'QuoteOfDayPluginModel'
        db.delete_table(u'djangocmsquickstart_quoteofdaypluginmodel')
    ...
    models = {
        ...
        u'djangocmsquickstart.productfeaturepluginmodel': {
            ...
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['djangocmsquickstart.Product']", 'null': 'True'}),
        ...
        u'djangocmsquickstart.quoteofdaypluginmodel': {
            'Meta': {'object_name': 'QuoteOfDayPluginModel', '_ormbases': ['cms.CMSPlugin']},
            'author': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True'}),
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'quote': ('django.db.models.fields.TextField', [], {'default': 'None', 'max_length': '1000', 'null': 'True'})
        },
