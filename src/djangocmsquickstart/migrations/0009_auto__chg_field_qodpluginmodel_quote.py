...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QODPluginModel.quote'
        db.alter_column(u'djangocmsquickstart_qodpluginmodel', 'quote', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'QODPluginModel.quote'
        db.alter_column(u'djangocmsquickstart_qodpluginmodel', 'quote', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
